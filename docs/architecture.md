...
| `charts/` | Framework-free SVG line/bar chart primitives. |
...
- **No frontend framework, zero JS dependencies.** Plain HTML and ES modules: works over `file://`, needs no build step, deploys to GitHub Pages as-is, and carries no bundler or supply-chain attack surface.
